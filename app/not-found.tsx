      ...
      <main id="main" className="min-h-[60vh] flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-4 justify-center max-w-md mx-auto">
            <Link 
              href="/"
              className="bg-riviera-gold text-white px-8 py-4 text-sm font-light tracking-widest hover:bg-riviera-text transition-colors focus:outline-none focus:ring-2 focus:ring-riviera-gold focus:ring-offset-2 text-center block w-full"
            >
              GO HOME →
            </Link>
            <Link 
