      ...
      <main id="main">
        ...
        <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div ref={gridRef as any} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {tourSections.map((section) => (
                <div key={section.slug} className="tour-card">
                  <Link
                    href={`/tour/${section.slug}`}
                    className="group relative overflow-hidden h-64 block focus:outline-none focus:ring-2 focus:ring-riviera-gold focus:ring-offset-2"
                  >
                    ...
                    <div className="absolute top-4 right-4 z-20">
                      <svg 
                        className="w-6 h-6 text-white group-hover:text-riviera-gold transition-all transform group-hover:translate-x-1" 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor"
                      >
