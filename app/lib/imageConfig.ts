...
export const imageConfig = {
  ...
  hero: [
    '/images/large/_0350158-by-p.jpg',
  ],

  // Hero Carousel - Multiple couples, rotating homepage hero
  // Displays 6 different wedding couples in rotation - UNIQUE TO CAROUSEL ONLY
  heroCarousel: [
  ...
  // Homepage Sections - UNIQUE images not used elsewhere
  homepage: {
    whyChooseUs: '/images/medium/_DSC8849sa-p.jpg',
    venue: '/images/medium/_DSC8864sa-p.jpg',
  },
  ...
  tour: {
    ...
    'indoor-ceremony': [
      ...
      '/images/medium/_2004444-sm-t.jpg',
    ],
    'outdoor-ceremony': [
      ...
      '/images/medium/_2004444-sm-t.jpg',
      '/images/medium/_2004477-sm-t.jpg',
      '/images/medium/_2004497-sm-t.jpg',
    ],
    'indoor-cocktail': [
      '/images/medium/_2005048-tc-p.jpg',
      '/images/medium/_2005105-tc-p.jpg',
      '/images/medium/_2005119-tc-p.jpg',
      '/images/medium/_2005129-tc-p.jpg',
      '/images/medium/_2005628-tc-p.jpg',
      '/images/medium/_2006091-tc-p (1).jpg',
    ],
    'outdoor-cocktail': [
      '/images/medium/_2006119-tc-p.jpg',
      '/images/medium/_2006182-tc-p.jpg',
      '/images/medium/_2006757-jd-p.jpg',
      '/images/medium/_2007163-jd-p.jpg',
      '/images/medium/_2007528-jd-p.jpg',
      '/images/medium/_2007564-jd-p.jpg',
    ],
    'main-ballroom': [
      '/images/medium/_2007634-jd-p.jpg',
      '/images/medium/_2007650-jd-p.jpg',
      '/images/medium/_2007664-jd-p.jpg',
      '/images/medium/_2007676-jd-p.jpg',
      '/images/medium/_2004380-sm-t.jpg',
      '/images/medium/_24M1353-jb-25-P.jpg',
    ],
    'sweetheart-table': [
      '/images/medium/_24M3331-sm-t.jpg',
      '/images/medium/_24M4079-sm-t.jpg',
      '/images/medium/_24M4629-tc-p.jpg',
      '/images/medium/_24M5094-tc-p.jpg',
    ...
    'guest-seating': [
      ...
      '/images/medium/_50M1309-jj-p.jpg',
    ...
    'photo-locations': [
      ...
      '/images/medium/_DSC3984km-p.jpg',
      '/images/medium/_DSC4038km-p.jpg',
  ...
  tourPreviews: {
    'entrance-lobby': '/images/medium/_0359672-by-p.jpg',
    'bridal-suite': '/images/medium/_1051082-ea-p.jpg',
    'indoor-ceremony': '/images/medium/_2000804-jb-25-P.jpg',
    'outdoor-ceremony': '/images/medium/_2004340-sm-t.jpg',
    'indoor-cocktail': '/images/medium/_2005048-tc-p.jpg',
    'outdoor-cocktail': '/images/medium/_2006119-tc-p.jpg',
    'main-ballroom': '/images/medium/_2007634-jd-p.jpg',
    'sweetheart-table': '/images/medium/_24M3331-sm-t.jpg',
    'guest-seating': '/images/medium/_50M1231-jj-p.jpg',
    'dancefloor': '/images/medium/_50M1509-ea-p.jpg',
    'entertainment': '/images/medium/_50M8937sa-p.jpg',
    'main-bar': '/images/medium/_COL4083ca-p.jpg',
    'balconies': '/images/medium/_DSC1442mj-p.jpg',
    'photo-locations': '/images/medium/_DSC3791kj-p.jpg'
  },
};
