              ...
              return (
                <HoverScale key={index} effect="lift">
                  <a
                    ...
                    className={`px-10 py-5 text-sm font-light tracking-widest transition-all text-center block w-full whitespace-nowrap ${colorScheme} focus:outline-none focus-visible:ring-2 focus-visible:ring-riviera-gold focus-visible:ring-offset-2`}
                  >
                    {button.text}
                  </a>
                </HoverScale>
