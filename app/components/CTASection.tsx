              ...
              return (
                <HoverScale key={index} effect="lift">
                  <a
                    ...
                    className={`px-10 py-5 text-sm font-light tracking-widest transition-all text-center block w-full whitespace-nowrap ${colorScheme} focus:outline-none focus:ring-2 focus:ring-riviera-gold focus:ring-offset-2`}
                  >
                    {button.text}
                  </a>
                </HoverScale>
