    ...
    return (
      <div className="text-center py-12">
        <a
          ...
          className="bg-riviera-gold text-white px-8 py-3 text-sm font-light tracking-widest hover:bg-riviera-text transition-colors text-center block max-w-md mx-auto"
        >
