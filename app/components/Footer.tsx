...
export default function Footer() {
  return (
    <footer className="relative text-white bg-riviera-dark-brown">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-sm font-light tracking-widest mb-4">FOLLOW OUR LONG ISLAND VENUE</h3>
            <p className="text-sm font-light opacity-90 mb-4">
              Get a front row seat to stunning Long Island waterfront weddings, behind the scenes setups at our Massapequa venue, and must know wedding updates.
            </p>
